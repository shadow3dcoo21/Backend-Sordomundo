  ...
  return (
    <nav className="bg-blue-600 p-4 flex justify-between items-center shadow-lg">
      <div className="flex space-x-4">
        <Link to="/alumno/completar" className="text-white hover:bg-blue-700 px-3 py-2 rounded">
          Completar
        </Link>
        <Link to="/alumno/diccionario" className="text-white hover:bg-blue-700 px-3 py-2 rounded">
          Diccionario
        </Link>
        <Link to="/alumno/examen" className="text-white hover:bg-blue-700 px-3 py-2 rounded">
          Examen
        </Link>
      </div>
